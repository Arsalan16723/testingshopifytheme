...
theme.MobileNav = (function() {
  ...
  function cacheSelectors() {
    cache = {
      ...
      $siteHeader: $('.site-header'),
      $siteHeaderBackground: $('.site-header-background'),
  ...
  function openMobileNav() {
    ...
    cache.$mobileNavContainer.prepareTransition().addClass(classes.navOpen);
      ...
      cache.$siteHeader.removeClass('background');
      cache.$siteHeaderBackground.removeClass('background');
      cache.$siteHeader.addClass('nav-open');
      cache.$mobileNavContainer.addClass('nav-open');
      cache.$siteHeaderBackground.addClass('nav-open');
  ...
  function closeMobileNav() {
    ...
    if(scroll > 120 ){
      cache.$siteHeader.addClass('background');
      cache.$siteHeaderBackground.addClass('background');
    }
    cache.$siteHeader.removeClass('nav-open');
    cache.$mobileNavContainer.removeClass('nav-open');
    cache.$siteHeaderBackground.removeClass('nav-open');
  ...
  Cart.prototype = _.assignIn({}, Cart.prototype, {
    _setupCartTemplates: function() {
      if($("body").hasClass('template-cart')){
        ...
        this.$itemTemplate = $(".cart-template-hidden .cart__row")
        .clone();
      }
    ...
    _createCart: function(state) {
      ...
      $(selectors.cartLineItems, this.$container).empty().html(
        this._createLineItemList(state)
      );

      console.log(this._createLineItemList(state));
    ...
    _createLineItemList: function(state) {
      return $.map(
        ...
        function(item, index) {
          ...
          var shortTitle = $.trim(item.product_title).substring(0, 20).split(" ").slice(0, -1).join(" ") + "...";
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _updateCartPopupContent: function(item) {
      ...
      $.getJSON('/cart.js').then(
        function(cart) {
          $('.slide-cart-outer div[data-cart-wrapper]').removeClass('hide');
          $('.slide-cart-outer div[data-empty-page-content]').addClass('hide');
          $('.slide-cart-overlay').addClass('slide');
          theme.Cart.prototype._createCart(cart);
